#!/usr/bin/env python3
"""
Plot Mapomatic pass time relative to the full-fidelity configuration.

Reads data/mapomatic_benchmarks.csv (generated by run_mapomatic_bench.sh) and
produces data/mapomatic_timing.pdf illustrating speedups.
"""
