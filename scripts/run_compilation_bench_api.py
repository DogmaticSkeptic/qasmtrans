#!/usr/bin/env python3
"""
Benchmark Qiskit (O1/O2/O3) vs. QASMTrans using the Python API, writing a CSV.
Keeps the original shell-based runner as a fallback; this version avoids spawning
the QASMTrans binary and parses metrics directly in Python.
"""
